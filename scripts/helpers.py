...
class Struct:
        ...
        if desc is not None:
            try:
                ...
                try:
                    ...
                    raise ValueError(
                        "Invalid Struct description {}".format(repr(desc)))
    ...
    def __eq__(self, other):
        ...
        return len(
            ...
            k in other.__dict__ and other.__dict__[k] == v for k,
            v in self.__dict__.items())
...
def load_by_name(module_string, path=None):
    ...
    try:
        ...
        try:
            ...
            if path is not None:
                module = __import__(
                    path, globals(), locals(), [filename]).__dict__[filename]
            else:
            ...
            __loaded_modules = __loaded_modules.union(
                set(sys.modules) - old_modules)
